            ...
            <div class="col-md-10">
                <div class="card shadow">
                    <div class="card-header bg-info text-white">
                        <h4 class="mb-0">Create Business Information</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.business-information.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" name="instagram_link" id="instagram_link" class="form-control @error('instagram_link') is-invalid @enderror" value="{{ old('instagram_link') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" name="twitter_link" id="twitter_link" class="form-control @error('twitter_link') is-invalid @enderror" value="{{ old('twitter_link') }}">
                                @error('twitter_link')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" name="youtube_link" id="youtube_link" class="form-control @error('youtube_link') is-invalid @enderror" value="{{ old('youtube_link') }}">
                                @error('youtube_link')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-grid mt-4">
                                <button type="submit" class="btn btn-info">Save Business Information</button>
                            </div>
                        </form>
                    </div>
                </div>
