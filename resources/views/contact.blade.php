<x-user-layout>
              ...
              <div class="position-relative bg-body-tertiary " style="min-height: 150vh;width:100vw">
                ...
                <div class="position-relative w-100  d-flex flex-column " style="z-index: 2;">
                    ...
                    <div class=" position-relative " >
                        ...
                        <div class="row position-relative  d-flex justify-content-center " >
                            <div class=" shadow  col-11 position-absolute d-flex justify-content-between rounded-5 " style="background: rgba(255, 255, 255, 0.2);
                                border-radius: 16px;
                              ...
                              <div class="vr bg-secondary my-auto rounded-pill" style="width: 3px; height:400px;"></div>
                             
                                <div class="col-lg-5  border-left border-info">
