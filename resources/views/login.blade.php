<x-user-layout>
    ...
    <div class="col-12 d-flex justify-content-center align-items-center my-5 ">
        <div class="col-11 col-md-9 col-lg-4  card border border-light-subtle rounded-4">
            <div class="card-body p-3 p-md-4 p-xl-5">
                ...
                <form action="{{route('account.authenticate')}}" method="POST" class="row gy-3 overflow-hidden">
                    @csrf
                        ...
                        <div class="col-12">
                            <div class="form-floating mb-3">
                                <input type="password" class="form-control form-control-sm @error('password') is-invalid @enderror" name="password" id="password" value="" placeholder="Password" >
                        ...
                        <div class="col-12">
                            <div class="d-grid">
                                <button class="btn bsb-btn-xl btn-info py-3" type="submit">Log in now</button>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-center">
                            ...
                            <a href="{{route('password.reset.form')}}" class="link-secondary text-primary">Forgot Password?</a>
                        </div>
                    </div>
                </div>
            </div>
