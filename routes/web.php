...
Route::group(['prefix'=>'account'],function(){
    ...
    Route::group(['middleware'=>['auth','verified']], function(){
        ...
        Route::post('blog/{id}', [PostController::class, 'addFavourite'])->name('favourite.add');
        Route::delete('blog/{id}', [PostController::class, 'removeFavourite'])->name('favourite.remove');
        ...
        Route::get('/user/messages/{message}/detail', [UserMessageController::class, 'detail'])->name('account.messages.detail');
...
Route::group(['prefix'=>'admin'],function(){
    ...
    Route::group(['middleware'=>'admin.auth'],function(){
        ...
        Route::put('blogs/featured/{post}',[AdminPostController::class,'updateFeatured'])->name('admin.post.featured.update');
